...
const graph = {
  nodes: [
    ...
    { id: 31, label: 'CI' },
    { id: 310, label: 'git-action' },
    { id: 311, label: 'jenkins' },
    { id: 312, label: 'docker' },
    { id: 313, label: 'kubernates' },
    { id: 314, label: 'travis' },
    ...
    { id: 332, label: 'trac' },
    { id: 4, label: 'Web Tech' },
    { id: 40, label: 'Framework or Tech1' },
    { id: 401, label: 'Solid.js' },
    { id: 402, label: 'Preact' },
    { id: 403, label: 'React' },
    { id: 404, label: 'Recoil' },
    { id: 405, label: 'Jotai' },
    { id: 406, label: 'zustand' },
    { id: 407, label: 'Redux' },
    { id: 408, label: 'Vue.js' },
    { id: 409, label: 'Dojo' },
    { id: 41, label: 'Util' },
    ...
    { id: 421, label: 'vite' },
    { id: 422, label: 'esbuild' },
    { id: 423, label: 'webpack' },
    { id: 424, label: 'gulp' },
    { id: 425, label: 'babel' },
    { id: 426, label: 'browserify' },
    { id: 427, label: 'rollupjs' },
    { id: 43, label: 'Lang' },
    ...
    { id: 435, label: 'sass' },
    { id: 45, label: 'Test' },
    { id: 450, label: 'artillery.js'},
    { id: 451, label: 'cypress'},
    { id: 452, label: 'playwright'},
    { id: 453, label: 'Jest' },
    { id: 454, label: 'Jasmine' },
    { id: 455, label: 'Qunit' },
    { id: 456, label: 'nGrinder' },
    { id: 46, label: 'Etc' },
    ...
    { id: 466, label: 'gatsby' },
    { id: 467, label: 'nx' },
    { id: 47, label: 'Framework or Tech2' },
    { id: 471, label: 'angular' },
    { id: 472, label: 'GraphQL' },
    { id: 473, label: 'Next.js' },
    { id: 474, label: 'recoil' },
    { id: 475, label: 'nest.js' },
    { id: 476, label: 'linaria' },
    { id: 477, label: 'JQuery UI' },
    { id: 5, label: 'Co-Work' },
    { id: 50, label: 'slack' },
    ...
    { id: 6, label: 'Server' },
    { id: 60, label: 'Node.js' },
    { id: 601, label: 'fastify' },
    { id: 602, label: 'express' },
    { id: 603, label: 'koa2' },
    { id: 604, label: 'pm2' },
    { id: 605, label: 'Sequelize(orm)' },
    { id: 61, label: 'nginx' },
